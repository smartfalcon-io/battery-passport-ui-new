...
// const API_URL = "/fetch-credential-details/db0ac7a0-af94-47df-a85e-3d0337637c6f";
// const BEARER_TOKEN = "YOUR_BEARER_TOKEN"; // Use full token here
...
//   return (
//     <div className="flex flex-col w-full p-5 mt-24">
//       <div className="flex flex-col md:flex-row w-full mt-20 items-start">
//         <div className="border border-gray-300 mb-12 p-4 rounded-lg w-full md:w-[29%] relative">
//           <span
...
//             <div>
//               <p>Passport ID</p>
//               <h4 className="text-lg font-semibold">{batteryData?.["Passport ID"]}</h4>
//             </div>
//             <div>
//               <p>Model Number</p>
//               <h4 className="text-lg font-semibold">{batteryData?.ModelNumber}</h4>
//             </div>
//             <div>
//               <p>Serial Number</p>
//               <h4 className="text-lg font-semibold">{batteryData?.SerialNumber}</h4>
//             </div>
//           </div>
//         </div>
        
//         <div className="flex flex-col items-center justify-center gap-4 md:gap-8 w-full md:w-[50%] md:ml-5">
//           <img
//             src="/src/assets/ev_battery.png"
//             alt="EV Battery"
...
//         <div className="mt-2 border w-full border-gray-300 rounded-lg">
...
// import CarbonFootprintContent from "./CarbonFootprintContent";
// import SignaturePopup from "./SignaturePopup";
// import "../assets/css/PassportDetails.css"; // This line may be removed
...
//   return (
//     <div className="flex flex-col w-full px-5 mt-24">
//       {/* First section */}
//       <div className="flex md:flex-wrap flex-row justify-between items-start w-full mt-20 ml-20">
//         {/* Passport Card Section */}
//         <div className="border border-gray-300 mb-12 p-4 rounded-lg w-1/3 box-border">
//           <span
//             className="ml-80"
//             onMouseEnter={() => setIsHovered(true)}
//             onMouseLeave={() => setIsHovered(false)}
...
//             <div className="passport-item">
//               <p>Passport ID</p>
//               <h4 className="font-bold">{batteryData?.["Passport ID"]}</h4>
//             </div>
//             <div className="passport-item">
//               <p>Model Number</p>
//               <h4 className="font-bold">{batteryData?.ModelNumber}</h4>
//             </div>
//             <div className="passport-item">
//               <p>Serial Number</p>
//               <h4 className="font-bold">{batteryData?.SerialNumber}</h4>
//             </div>
//           </div>
//         </div>

//         {/* Images Section */}
//         <div className="flex flex-row items-center gap-2 justify-evenly mx-12">
//           <img src="/src/assets/ev_battery.png" alt="EV Battery" className="mb-7 max-w-full h-auto" />
//           <div className="">
//             <p><strong>Economic operator</strong></p>
...
//       {/* Second Section */}
//       <div className="w-full box-border p-24 mt-[3rem]">
//         <Link to="/home" className="text-gray-600 text-xl">
//           <span>←</span> Back to summary
//         </Link>
//         <div className="border border-gray-300 rounded-lg p-1 mt-2 z-10">
//           <div className="flex gap-3 h-13  rounded-lg">
//             {tabs.map((tab) => (
//               <button
//                 key={tab.id}
//                 onClick={() => setActiveTab(tab.id)}
...
//           </div>
//         </div>
//         <div className="p-5 border border-gray-300 rounded-lg mt-2">{renderContent(activeTab)}</div>
//       </div>
//     </div>
//   );
// };
...
const PassportDetails: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full px-5 mt-24">
      {/* First Section */}
      <div className="flex flex-col md:flex-row justify-between items-start w-full mt-20 ml-0 lg:ml-32">
        {/* Passport Card Section */}
        <div className="border border-gray-300 mb-12 p-4 rounded-lg md:w-1/3 box-border">
          <span
            className="ml-80"
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
        ...
        {/* Images Section */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mx-0 md:mx-12">
          <img src="/src/assets/ev_battery.png" alt="EV Battery" className="mb-7 max-w-full h-auto" />
          <div className="">
            <p><strong>Economic operator</strong></p>
            <div className="flex justify-center w-1/2">
      ...
      {/* Second Section */}
      <div className="w-full max-w-6xl mx-auto box-border p-6 md:p-12 mt-6 md:mt-12">
        <Link to="/home" className="text-gray-600 text-xl">
          <span>←</span> Back to summary
        </Link>
        <div className="border border-gray-300 rounded-lg p-1 mt-2 z-10">
          <div className="flex flex-wrap gap-3 h-13 rounded-lg ">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
